...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    if 0 in (score0, score1) or 1 in (score0, score1):
        return False
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def score_record(score0, score1):
        if who == 0:
            score = score0
        else:
            score = score1
        if previous_high < score - previous_score:
            if score - previous_score == 1:
                print("1 point! That's the biggest gain yet for Player %d"
                      % who)
            else:
                print("%d points! That's the biggest gain yet for Player %d"
                      % (score - previous_score, who))
            new_high = score - previous_score
        else:
            new_high = previous_high
        return announce_highest(who, previous_high=new_high,
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    previous_dice, max_num_rolls = 0, 0
    for i in range(1, 11):
        average_func = make_averaged(roll_dice, num_samples)
        averaged_dice = average_func(i, dice)
        if averaged_dice > previous_dice:
            previous_dice, max_num_rolls = averaged_dice, i
